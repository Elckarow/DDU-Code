...
default phone.system.battery_level = 100 # If not `None`, an integer.
...
default phone.system.locked = True
...
default phone.system.internet_connection = False # Phone wifi can be on, yet no internet connection.
