                        ...
                        use _phone_control_center_block(cols=2, rows=2, layout="grid"):
                            ...
                            button at _fits_block align (0.5, 0.5):
                                ...
                                action (
                                    ...
                                    SelectedIf(phone.system.cellular_data),
                                    SensitiveIf(not phone.system.locked)
                                )
                                selected_background CircleDisplayable("#35C759")
                                padding (90, 90)
...
screen _phone_control_center_block(cols=1, rows=1, layout="empty"):
    frame at (RoundedCorners(gui.phone_control_center_block_rounded_corners_radius), Flatten):
...
style _phone_control_center_button is empty:
    padding (70, 70)
    background             None
    hover_background       CircleDisplayable(color="#5a5a5a")
    selected_background    CircleDisplayable(color="#007BFA")
    # insensitive_background CircleDisplayable(color="#b1b1b1")
